...
public class UserTypingStatusManager implements ValueEventListener {
    ...
    public static boolean isUserTyping(BaseUser user, Context context) {
        return (mTypingUserList.contains(user.getId()) && BaseUtils.canConnect(context.getApplicationContext()));
    }
