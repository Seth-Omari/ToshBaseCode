...
import ke.co.toshngure.chatsdk.model.BaseMessage;
...
public class FirebaseUtils {
     ...
     */
    public static DatabaseReference getReadReceiptRef(BaseMessage message) {
     ...
     */
    public static DatabaseReference getDeviceReceiptRef(BaseMessage message) {
        return FirebaseDatabase.getInstance().getReference()
                .child(CHATS_CHILD)
                .child(String.valueOf(message.getConversationId()))
                .child(MESSAGES)
     ...
     */
    public static DatabaseReference getServerReceiptRef(BaseMessage message) {
        return FirebaseDatabase.getInstance().getReference()
                .child(CHATS_CHILD)
                .child(String.valueOf(message.getConversationId()))
                .child(MESSAGES)
