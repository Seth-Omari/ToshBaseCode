...
import com.vibecampo.android.database.Database;
import ke.co.laysan.baseapp.log.BeeLog;
import com.vibecampo.android.model.Message;
import com.vibecampo.android.utils.FirebaseUtils;
import com.vibecampo.android.utils.MessageUtils;
...
public class MessageReceiptManager implements ValueEventListener {
    ...
    public void onDataChange(DataSnapshot dataSnapshot) {
        ...
        Message message = Database.getInstance().getMessageDao()
