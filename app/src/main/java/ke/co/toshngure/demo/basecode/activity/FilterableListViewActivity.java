...
import ke.co.toshngure.basecode.view.autocomplete.FilterableListView;
import ke.co.toshngure.demo.basecode.R;
import ke.co.toshngure.demo.basecode.model.Post;

public class FilterableListViewActivity extends BaseActivity {

    private static final String EXTRA_FROM_NETWORK = "extra_from_network";

    @BindView(R.id.filterableLV)
    FilterableListView filterableLV;
    @BindArray(R.array.counties)
    String[] counties;

    public static void start(Context context, boolean fromNetwork) {
        Intent starter = new Intent(context, FilterableListViewActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_filterable_list_view);
        ...
        filterableLV.setFilterAdapterConfig(fromNetwork ? postsFilterAdapterConfig : countiesFilterAdapterConfig);
    }
